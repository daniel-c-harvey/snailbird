...
{
    protected override FlexPostManagerUpdate<TPost> CreateUpdate(IPostManagerClient<TPost> client, Navigator<PostManagerMode, PostManagerModel<TPost>> navigator)
    {
